...
gulp.task('styles', function () {
  gulp.src('src/scss/minimenu.scss')
    .pipe(sourcemaps.init())

      // scss output compressed if production or expanded if development
      .pipe(gulpif(env === 'production', sass({ includePaths: require('node-bourbon').includePaths, outputStyle: 'compressed' }),
        sass({ includePaths: require('node-bourbon').includePaths, outputStyle: 'expanded' })))
      .on('error', gutil.log.bind(gutil, gutil.colors.red(
         '\n\n*********************************** \n' +
        'SASS ERROR:' +
        '\n*********************************** \n\n'
...
gulp.task('c;:maps', (env === 'production', deleteMapsFolder));
